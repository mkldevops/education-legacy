 ...
 */
final class Version20210522201316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE class_period_student (class_period_id INT NOT NULL, student_id INT NOT NULL, author_id INT DEFAULT NULL, begin DATETIME NOT NULL, end DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_8A4414AF8754E5E1 (class_period_id), INDEX IDX_8A4414AFCB944F1A (student_id), INDEX IDX_8A4414AFF675F31B (author_id), PRIMARY KEY(class_period_id, student_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE diploma (id INT AUTO_INCREMENT NOT NULL, document_id INT DEFAULT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_original_name VARCHAR(255) DEFAULT NULL, image_mime_type VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, image_dimensions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', INDEX IDX_EC218957C33F7837 (document_id), INDEX IDX_EC218957F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, school_id INT DEFAULT NULL, mime VARCHAR(30) DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, extension VARCHAR(10) NOT NULL, size INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_D8698A76F675F31B (author_id), INDEX IDX_D8698A76C32A47EE (school_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE family (id INT AUTO_INCREMENT NOT NULL, father_id INT DEFAULT NULL, mother_id INT DEFAULT NULL, legal_guardian_id INT DEFAULT NULL, author_id INT DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, number_children INT NOT NULL, person_authorized VARCHAR(255) DEFAULT NULL, person_emergency VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, zip VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_A5E6215B2055B9A2 (father_id), UNIQUE INDEX UNIQ_A5E6215BB78A354D (mother_id), UNIQUE INDEX UNIQ_A5E6215B40A26EB (legal_guardian_id), INDEX IDX_A5E6215BF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE payment_package_student (id INT AUTO_INCREMENT NOT NULL, package_student_period_id INT NOT NULL, operation_id INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, enable TINYINT(1) NOT NULL, INDEX IDX_3FF0261C173AE3B1 (package_student_period_id), UNIQUE INDEX UNIQ_3FF0261C44AC3583 (operation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE period (id INT AUTO_INCREMENT NOT NULL, diploma_id INT DEFAULT NULL, author_id INT DEFAULT NULL, begin DATETIME NOT NULL, end DATETIME NOT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_C5B81ECEA99ACEB5 (diploma_id), INDEX IDX_C5B81ECEF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE person_member (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, structure_id INT DEFAULT NULL, author_id INT DEFAULT NULL, position_name VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_EC41CACE217BBB47 (person_id), INDEX IDX_EC41CACE2534008B (structure_id), INDEX IDX_EC41CACEF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE school (id INT AUTO_INCREMENT NOT NULL, director_id INT DEFAULT NULL, structure_id INT DEFAULT NULL, author_id INT DEFAULT NULL, principal TINYINT(1) DEFAULT \'0\' NOT NULL, name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, comment LONGTEXT DEFAULT NULL, zip VARCHAR(10) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, INDEX IDX_F99EDABB899FB366 (director_id), INDEX IDX_F99EDABB2534008B (structure_id), INDEX IDX_F99EDABBF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE structure (id INT AUTO_INCREMENT NOT NULL, president_id INT DEFAULT NULL, treasurer_id INT DEFAULT NULL, secretary_id INT DEFAULT NULL, author_id INT DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, options JSON NOT NULL COMMENT \'(DC2Type:json_array)\', name VARCHAR(255) DEFAULT NULL, enable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, zip VARCHAR(10) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, INDEX IDX_6F0137EAB40A33C7 (president_id), INDEX IDX_6F0137EA55808438 (treasurer_id), INDEX IDX_6F0137EAA2A63DB2 (secretary_id), INDEX IDX_6F0137EAF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE validate (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, type VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_42123254F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
